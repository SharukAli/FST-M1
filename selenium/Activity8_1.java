...
public class Activity8_1 {
    public static void main(String[] args) {
        ...
        //Get columns
        List cols = (List) driver.findElements(By.xpath("//table[contains(@class, 'striped')]/tbody/tr[1]/td"));
        //Get rows
        List rows = driver.findElements(By.xpath("//table[contains(@class, 'striped')]/tbody/tr"));
        ...
        List thirdRow = (List) driver.findElements(By.xpath("//table[contains(@class, 'striped')]/tbody/tr[3]/td"));
